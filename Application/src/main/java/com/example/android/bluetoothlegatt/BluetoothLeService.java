...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                                            BluetoothGattCharacteristic characteristic) {
                                                Log.d("click on notification","characteristic changed");
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
        }
    };
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            Log.d("data","data has length:"+data.length);
            if (data != null && data.length > 0) {
                final StringBuilder stringBuilder = new StringBuilder(data.length);
                if(fromByte(data[0]).get(0)){
                    Log.d("bit","temperature unit is fahrenheit");
                }
                else{
                    Log.d("bit","temperature unit is celcius");
                }
    ...
    public static float readHealthFloat32(byte[] data) {
        byte b0 = data[0];
        byte b1 = data[1];
        byte b2 = data[2];
        byte b3 = data[3];
    ...
    public void setCCCD(){
        Log.d("click for notification", "set CCDD");
        BluetoothGattService bluetoothGattService = mBluetoothGatt.getService(UUID.fromString("00001809-0000-1000-8000-00805f9b34fb"));
        Log.d("cccd","service:"+bluetoothGattService);
...
Log.d("cccd","characteristic"+bluetoothGattCharacteristic);
                        BluetoothGattDescriptor descriptor = bluetoothGattCharacteristic.getDescriptor(
                        CCCD_ID);
                        Log.d("cccd","descriptor:"+descriptor);

                        Log.i("click for notification", "descriptor " + descriptor);
                        descriptor.setValue(BluetoothGattDescriptor.ENABLE_INDICATION_VALUE);
                        mBluetoothGatt.writeDescriptor(descriptor);
                        Log.d("click for notification", "end set CCDD");
    }
